...
const Home = () => (
    <div className='book-home-page-bg-continer'>
        ...
        <ul className='book-home-page-books-list'>
            {booksData.books.map(book => (
                <li  key={book.id} className="home-page-book-item">
                    <Link className='home-page-book-item-link' to={`/book-view/${book.id}`} >
        ...
        <Link to='/add-new-book'>
            <button className='home-page-add-button' type='button'>AddBook</button>
        </Link>
        </div>
    </div>
)
